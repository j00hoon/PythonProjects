...
gray_cnt = len(data[data['Primary Fur Color'] == "Gray"])
cinnamon_cnt = len(data[data['Primary Fur Color'] == "Cinnamon"])
...
print(data_frame)
data_frame.to_csv("./squirrel_count_in_central_park.csv")
